...
//  TripSimulatorExtension
//
//  Created by Billy Lo on 2020-07-27.
//
...
class ShareViewController: SLComposeServiceViewController {
    ...
    override func loadView() {
        ...
        self.title = NSLocalizedString("TripSimulatorExtension", comment: "Title of the Social Service")
    ...
    override func didSelectPost() {
        ...
        for item in inputItems {
            let itemE = item as! NSExtensionItem
            print(itemE)
        }
